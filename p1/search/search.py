...
def uniformCostSearch(problem):
    ...
    start_state=problem.getStartState()
    fringe.push((start_state, [], 0), 0)  # (state, actions, cost), priority=cost
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    fringe=util.PriorityQueue() # use priority queue for A*
    visited=set()

    start_state=problem.getStartState()
    fringe.push((start_state, [], 0), heuristic(start_state, problem))  # (state, actions, cost), priority=f(n)
