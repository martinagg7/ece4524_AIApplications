...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.startingPosition, ()  # (position, visited_corners)
    ...
    def isGoalState(self, state):
        ...
        return len(visited_corners) == len(self.corners)  # Goal is to visit all corners
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append((next_state, action, 1))  # stepCost is 1
...
def foodHeuristic(state, problem):
    ...
    distances=[mazeDistance(position, foodPos, problem.startingGameState) for foodPos in foodPositions]
    return max(distances)  # Return the maximum distance to any food as the heuristic
